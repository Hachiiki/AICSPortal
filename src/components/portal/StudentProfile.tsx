...
/**
 * The student profile page. Shows a header card with avatar and badges,
 * quick stats, personal information grid, digital ID card preview,
 * submitted documents list, and the Certificate of Enrollment section
 * with preview/print/download actions.
 */
