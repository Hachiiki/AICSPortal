...
export default function AICSLoginPage() {
  ...
  return (
    ...
    >
      {/* ============ LEFT 60% — School image + overlay branding ============ */}
      <section
      ...
      >
        ...
        />
        {/* Color wash overlay using the palette */}
        <div
      ...
      >
        ...
        <div className="relative w-full max-w-sm lg:ml-16">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3 py-2.5 rounded-lg text-sm bg-white border outline-none transition-all focus:ring-2"
                      style={{
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    boxShadow: `inset 0 0 0 1px ${PALETTE.mist}`,
                  }}
                >
                  {/* Hidden video element always mounted when active */}
                  {(faceState === 'starting' ||
                    faceState === 'scanning' ||
                    faceState === 'verifying' ||
                    faceState === 'success') && (
                      ...
                      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                        ...
                        >
                          ...
                          {['-top-1 -left-1 border-t-2 border-l-2',
                            ...
                            '-bottom-1 -right-1 border-b-2 border-r-2'].map(
                            (pos) => (
                              <span
                                key={pos}
          ...
          <p className="mt-6 text-center text-[11px]" style={{ color: '#9ca3af' }}>
            © {new Date().getFullYear()} Asian Institute of Computer Studies. All rights reserved.
          </p>
        </div>
      </section>
    </main>
