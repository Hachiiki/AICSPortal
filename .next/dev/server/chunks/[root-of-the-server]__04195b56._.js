...
"[project]/src/app/api/enrollment/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const student = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2f$queries$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStudentByUsername"])(username);
        if (!student) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
        ...
        const enrollment = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2f$queries$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getEnrollment"])(student.username, student.branch, {
        ...
        if (!enrollment) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                error: 'No enrollment record found for this term.'
            }, {
                status: 404
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__04195b56._.js.map