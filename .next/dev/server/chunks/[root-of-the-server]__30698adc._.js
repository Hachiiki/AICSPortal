...
async function GET(request) {
    try {
        ...
        const events = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2f$queries$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getEvents"])(student.branch);
        const clientEvents = events.map((e)=>({
                _id: e._id?.toString() || '',
                title: e.title,
                description: e.description ?? null,
                date: e.date instanceof Date ? e.date.toISOString() : String(e.date),
                endDate: e.endDate ? e.endDate instanceof Date ? e.endDate.toISOString() : String(e.endDate) : null,
                category: e.category
            }));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__30698adc._.js.map