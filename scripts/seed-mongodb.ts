...
async function seed() {
  ...
  // TERM 1: 1st Year / 1st Sem / AY 2025-2026 — completed with released
  // grades (restored per owner request 2026-09-12; the 2nd Year term
  // below stays INC / in-progress as the current term).
  const term1Subjects = [
    { branch: BRANCH, studentUsername: 'juan.santos', code: 'CS 101', title: 'Introduction to Computing', units: 3, professor: 'Engr. Maria Cristina Reyes', professorEmail: 'm.reyes@aics.edu.ph', schedule: 'Mon / Wed 8:00 - 9:30 AM', room: 'Room 101', prelim: '88', midterm: '90', finals: '92', finalGrade: '90.20', remarks: 'Excellent', academicYear: '2025-2026', semester: '1st Sem', yearLevel: '1st Year', status: 'completed', gradeStatus: 'released', prelimStatus: 'released', midtermStatus: 'released', finalsStatus: 'released' },
    { branch: BRANCH, studentUsername: 'juan.santos', code: 'CS 102', title: 'Computer Programming I', units: 3, professor: 'Engr. Carlos Santos', professorEmail: 'c.santos@aics.edu.ph', schedule: 'Tue / Thu 10:00 - 11:30 AM', room: 'Room 105', prelim: '85', midterm: '87', finals: '89', finalGrade: '87.20', remarks: 'Very Good', academicYear: '2025-2026', semester: '1st Sem', yearLevel: '1st Year', status: 'completed', gradeStatus: 'released', prelimStatus: 'released', midtermStatus: 'released', finalsStatus: 'released' },
    { branch: BRANCH, studentUsername: 'juan.santos', code: 'CS 201', title: 'Data Structures and Algorithms', units: 3, professor: 'Prof. Anna Lim', professorEmail: 'a.lim@aics.edu.ph', schedule: 'Mon / Wed 10:00 - 11:30 AM', room: 'Lab 201', prelim: '82', midterm: '84', finals: '86', finalGrade: '84.20', remarks: 'Good', academicYear: '2025-2026', semester: '1st Sem', yearLevel: '1st Year', status: 'completed', gradeStatus: 'released', prelimStatus: 'released', midtermStatus: 'released', finalsStatus: 'released' },
    { branch: BRANCH, studentUsername: 'juan.santos', code: 'CS 202', title: 'Object-Oriented Programming', units: 3, professor: 'Engr. Roberto Cruz', professorEmail: 'r.cruz@aics.edu.ph', schedule: 'Fri 8:00 - 9:30 AM', room: 'Room 203', prelim: '78', midterm: '80', finals: '83', finalGrade: '80.60', remarks: 'Good', academicYear: '2025-2026', semester: '1st Sem', yearLevel: '1st Year', status: 'completed', gradeStatus: 'released', prelimStatus: 'released', midtermStatus: 'released', finalsStatus: 'released' },
    { branch: BRANCH, studentUsername: 'juan.santos', code: 'CS 203', title: 'Database Systems', units: 3, professor: 'Prof. Patricia Villanueva', professorEmail: 'p.villanueva@aics.edu.ph', schedule: 'Mon / Tue 1:00 - 2:30 PM', room: 'Lab 202', prelim: '76', midterm: '79', finals: '81', finalGrade: '78.90', remarks: 'Passed', academicYear: '2025-2026', semester: '1st Sem', yearLevel: '1st Year', status: 'completed', gradeStatus: 'released', prelimStatus: 'released', midtermStatus: 'released', finalsStatus: 'released' },
    { branch: BRANCH, studentUsername: 'juan.santos', code: 'CS 204', title: 'Web Development', units: 3, professor: 'Engr. James Villanueva', professorEmail: 'j.villanueva@aics.edu.ph', schedule: 'Thu 1:00 - 2:30 PM', room: 'Lab 203', prelim: '86', midterm: '83', finals: '88', finalGrade: '85.90', remarks: 'Very Good', academicYear: '2025-2026', semester: '1st Sem', yearLevel: '1st Year', status: 'completed', gradeStatus: 'released', prelimStatus: 'released', midtermStatus: 'released', finalsStatus: 'released' },
    { branch: BRANCH, studentUsername: 'juan.santos', code: 'PE 1', title: 'Physical Fitness', units: 2, professor: 'Coach Felix Guerrero', professorEmail: 'f.guerrero@aics.edu.ph', schedule: 'Sat 8:00 - 10:00 AM', room: 'Gymnasium', prelim: '90', midterm: '92', finals: '94', finalGrade: '92.20', remarks: 'Excellent', academicYear: '2025-2026', semester: '1st Sem', yearLevel: '1st Year', status: 'completed', gradeStatus: 'released', prelimStatus: 'released', midtermStatus: 'released', finalsStatus: 'released' },
  ]
