...
| Not Started | #22 | Medium | tables | Sticky header + first column for grade table | `FacultyGradeEncodingPage.tsx:392-429`, roster + release-queue tables, `ScheduleGrid.tsx:203` (reference) | Created 2026-09-11. #17 delivered sticky thead + first col; remaining: freeze Final when `period=all`, assess roster/queue tables. |
| Not Started | #24 | Medium | design-system | Unify remark badges, drop `dangerouslySetInnerHTML` | `RemarksBadge.tsx:19-24`, `FacultyGradeEncodingPage.tsx:34-38,420` | Created 2026-09-11. Delete local fn, reuse component, cover all 7 remarks. |
| Not Started | #23 | Medium | design-system | JS hover to Tailwind hover | `Sidebar.tsx:71-81`, `CredentialsForm.tsx:194-199` | Created 2026-09-11. Pure Tailwind + press scale, same colors. |
| Not Started | #21 | Medium | a11y / touch | Touch targets below 24px | `FacultyGradeEncodingPage.tsx:423`, `CredentialsForm.tsx:160-165`, `GlobalSearch.tsx:411-421` | Created 2026-09-11. Verified: bell (36px) already passes, out of scope. Min `h-9 min-w-9`, checkbox `w-5 h-5`. |
| Not Started | #27 | Medium | typography | Lock H1 + `tabular-nums` | `AcademicHeader.tsx:34`, Grade Encoding + Admin H1, `ScheduleGrid.tsx:179` | Created 2026-09-11. `text-2xl font-bold tracking-tight text-slate-900`; hero keeps `blue-950`. |
| Not Started | #25 | Medium | feedback | Toast position + actions | `src/app/layout.tsx:55`, grade toasts, `AnnouncementsDeck.tsx` dismissals | Created 2026-09-11. `bottom-right`/`bottom-center`; View queue / Undo actions. |
| Not Started | #28 | Medium | states | Standard empty/error patterns | `FacultyGradeEncodingPage.tsx:430`, `src/app/page.tsx:445-461` | Created 2026-09-11. Clear-filters action; Retry + sign-out error pattern. Announcements/admin patterns are the reference. |
| Not Started | #26 | Low | polish | Login radius, forgot-pw toast, back icon, dot hack, icon sizes | `LoginView.tsx:115`, `CredentialsForm.tsx:178-185`, `FacultyGradeEncodingPage.tsx:337`, `AnnouncementsDeck.tsx:215` | Created 2026-09-11. Batched L1-L5, one PR. L2 needs a confirmed-real contact. |
